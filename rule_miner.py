...
class RuleMiner(object):
    ...
    def get_frequent_itemsets(self, data):
        ...
        while flag:
            ...
            for itemset in itemsets:
                ...
                # this class.
                num = self.get_support(data, itemset)
                if num >= self.support_t:
    ...
    def get_confidence(self, data, rule):
        ...
        return  self.get_support(data, rule_3) / self.get_support(data, rule_1)
        pass
    ...
    def get_association_rules(self, data):
        ...
        for rule in rules:
            ...
            # this class.
            for unit in rule:
                num = self.get_confidence(data, unit)
                if num >= self.confidence_t:
                         association_rules.append(unit)
